# Directory Guide: `plugins/connectors/onebot-v11/src`
...
该目录存放 `plugins/connectors/onebot-v11/src` 对应模块边界的源码。建议先读直接入口，再按子包和测试继续展开。

## Contents / 内容

| File | Responsibility | 职责 |
| --- | --- | --- |
| _(none)_ | No direct source file; this package organizes child modules. | 无直接源码文件；本包用于组织子模块。 |

### Child directories / 子目录

| Directory | Responsibility | 职责 |
| --- | --- | --- |
| `onebot_v11_connector/` | Child package or layer | 子包或分层目录 |
